        ...
        >
          <Spin spinning={dataLoading}>
            <div
              ...
              style={{
                borderColor: data?.spaceTrack?.DECAYED ? 'rgba(250, 112, 102, 0.5)' : 'rgba(86, 237, 92, 0.5)',
                borderWidth: '1px',
            ...
            >
              ...
              <div className='mt-1'>
                  ...
                  <div className={`poppins-400-16 ${data?.spaceTrack?.DECAYED ? 'text-[#FA7066]' : 'text-[#56ED5C]'}`}>{data?.spaceTrack?.DECAYED ? 'Decayed' : 'Operational'}</div>
              </div>
