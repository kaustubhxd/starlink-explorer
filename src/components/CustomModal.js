...
const CustomModal = ({ open, id, closeModal }) => {
  ...
  return (
    <div 
        id='info-modal-bg'
        className='absolute top-0 left-0 h-screen w-screen bg-[rgba(0,0,0,0.2)] flex items-center justify-center'
        onClick={(e) => {
            e.stopPropagation()
    ...
    >
        ...
        >
        <div 
            className='rounded-xl border bg-[#161B22] opacity-90 p-4'
            style={{
                borderColor: '#56ED5C',
                borderWidth: '1px',
